...
// generic "fill this fret window with a scale" scan used both to build
// modes.html's diatonic boxes (via its own widen-to-3-notes caching layer)
// and scales.html's diatonic boxes (used directly, no widening).
